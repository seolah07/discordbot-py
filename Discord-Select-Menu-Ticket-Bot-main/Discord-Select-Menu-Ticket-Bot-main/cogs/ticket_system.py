...
GUILD_ID = config["1204886185709797426"] #Your Server ID aka Guild ID 
TICKET_CHANNEL = config["t1204886186913439795"] #Ticket Channel where the Bot should send the SelectMenu + Embed

CATEGORY_ID1 = config["1204886186527694909"] #Category 1 where the Bot should open the Ticket for the Ticket option 1
CATEGORY_ID2 = config["1204886186527694909"] #Category 2 where the Bot should open the Ticket for the Ticket option 2

TEAM_ROLE1 = config["1204886185709797434"] #Staff Team role id
TEAM_ROLE2 = config["1204886185709797432"] #Staff Team role id

LOG_CHANNEL = config["1204897626668146688"] #Where the Bot should log everything 
